...
void WriteOneDot(unsigned char color)
{ 
...
void DispColor1(unsigned char colorH,unsigned char colorL)
{
	unsigned int i,j,k;
...
void DispFrame(void)
{
	...
	DBH=RED>>8;DBL=RED,WR0=0;WR0=1;
	for(i=0;i<COL-2;i++){DBH=RED>>8;DBL=RED;WR0=0;WR0=1;}
	DBH=RED>>8;DBL=RED,WR0=0;WR0=1;

	for(j=0;j<ROW-2;j++)
	{
		DBH=RED>>8;DBL=RED;WR0=0;WR0=1;
		for(i=0;i<COL-2;i++){DBH=BLACK>>8;DBL=BLACK;WR0=0;WR0=1;}
		DBH=RED>>8;DBL=RED;WR0=0;WR0=1;
	}
