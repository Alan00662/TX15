...
#define ATK_MD0350_TOUCH_SPI_MI_GPIO_PIN            GPIO_PIN_12
#define ATK_MD0350_TOUCH_SPI_MI_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)
#define ATK_MD0350_TOUCH_SPI_MO_GPIO_PORT           GPIOD
#define ATK_MD0350_TOUCH_SPI_MO_GPIO_PIN            GPIO_PIN_13
#define ATK_MD0350_TOUCH_SPI_MO_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)
#define ATK_MD0350_TOUCH_SPI_TCS_GPIO_PORT          GPIOD
...
#define ATK_MD0350_TOUCH_SPI_CLK_GPIO_PORT          GPIOD
#define ATK_MD0350_TOUCH_SPI_CLK_GPIO_PIN           GPIO_PIN_12
