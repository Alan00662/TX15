...
uint8_t atk_md0350_init(void)
{
    ...
    atk_md0350_hw_init();               /* 1.开背光 */
    atk_md0350_gpio_init();             /* 2.GPIO接口初始化 */
    Mychip_id = atk_md0350_get_chip_id(); /* 3.获取ATK-MD0350模块驱动器ID */
...
//    }
    atk_md0350_reg_init(); 		//4.寄存器初始化
    atk_md0350_set_disp_dir(ATK_MD0350_LCD_DISP_DIR_0); //5.设置屏幕方向
