 ...
 * @retval  ADC结果
 */
uint32_t adc1_get_result(uint32_t channel)
{
 ...
 * @retval  ADC结果
 */
uint32_t adc1_get_result_average(uint32_t channel, uint8_t times)
{
    ...
    {
        sum_result += adc1_get_result(channel);
    }
 ...
 * @retval  无
 */
void adc1_dma_init(uint32_t memory_base)
{
    GPIO_InitTypeDef gpio_init_struct = {0};
    RCC_PeriphCLKInitTypeDef rcc_periph_clk_init_struct = {0};
    /* 配置时钟 */
 ...
 * @retval  无
 */
void adc1_nch_dma_init(uint32_t memory_base)
{
    GPIO_InitTypeDef gpio_init_struct = {0};
    RCC_PeriphCLKInitTypeDef rcc_periph_clk_init_struct = {0};
    /* 配置时钟 */
 ...
 * @retval  无
 */
void adc1_nch_dma_enable(uint32_t length)
{
    ADC_ChannelConfTypeDef adc_channel_conf_struct = {0};
 ...
 * @retval  无
 */
void adc1_oversample_init(uint32_t ratio, uint32_t right_shift)
{
    GPIO_InitTypeDef gpio_init_struct = {0};
    RCC_PeriphCLKInitTypeDef rcc_periph_clk_init_struct = {0};
    /* 配置时钟 */
